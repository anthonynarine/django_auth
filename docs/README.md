...
| [`AUTH_FLOWS.md`](AUTH_FLOWS.md) | Sequence diagrams for every flow: register, login, 2FA login, 2FA setup, token refresh, password reset, logout |
| [`API_REFERENCE.md`](API_REFERENCE.md) | Every endpoint — method, auth requirement, throttle scope, request/response shape |
